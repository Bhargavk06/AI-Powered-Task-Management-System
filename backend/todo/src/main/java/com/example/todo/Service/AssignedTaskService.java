...
public class AssignedTaskService {
 ...
 // ... (Add these methods to your existing AssignedTaskService)
  ...
  public List<AssignedTask> getTasksByAssigner(String userId, String assignerNameOrId) {
        ...
        System.out.println("DEBUG: getTasksByAssigner called for userId=" + userId + ", assigner=" + assignerNameOrId + ", returned " + tasks.size() + " tasks");
        return tasks;
  }
    ...
    public void updateStatus(Long taskId, String status, String updatedByUserId) {
         ...
         UserAuthentication statusChanger = userRepository.findById(updatedByUserId)
                 .orElseThrow(() -> new RuntimeException("User who updated status not found with ID: " + updatedByUserId));
    ...
    private void sendReviewNotificationEmail(UserAuthentication recipient, UserAuthentication sender, AssignedTask task) {
    ...
    private void sendStatusUpdateInAppNotification(UserAuthentication recipient, UserAuthentication sender, AssignedTask task) {
        String message;
